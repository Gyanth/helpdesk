    ...
    Sub procesarLogin()
        Try
            If txt_usuariologin.Text.Trim = "" Or txt_contraseñalogin.Text.Trim = "" Then
                ...
                Exit Sub
            Else
                Dim cls As New ServiceReference1.ClsUsuario
                cls.usuario = txt_usuariologin.Text
                cls.password = txt_contraseñalogin.Text
                ...
                Dim rptVal As Integer = cliente.validarLogin(cls)
